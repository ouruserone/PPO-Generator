...
def get_similar_docs_id(vectorstore, topic_name, sub_topic):
    ...
    # input_text = "Top 5 Articles which are about {} and range between year 2023, month 07, day 21, hour 10  and year 2023, month 07, day 22, hour 10".format(sub_topic)
    # today = datetime.now()
    # if sub_topic:
    #     input_text = "Top 5 Articles which are about {} for {}".format(sub_topic, today)
    # else:
    #     input_text = "Top 5 Articles which are about {} for {}".format(topic_name, today)
